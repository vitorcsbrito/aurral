...
| `POST` | `/api/playlists/flows` | Create a flow; requires a user session |
...
| `PUT` | `/api/playlists/shared-playlists/:playlistId/track-availability` | Show or hide track availability for a shared playlist |
